...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 10, 171, 301))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "消息对话框"))
        self.pushButton_2.setText(_translate("Form", "错误对话框"))
        self.pushButton_3.setText(_translate("Form", "问答对话框"))
        self.pushButton_4.setText(_translate("Form", "关于对话框"))
        self.pushButton_5.setText(_translate("Form", "警告对话框"))
