# Form implementation generated from reading ui file 'QToolBox容器.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.toolBox.setGeometry(QtCore.QRect(10, 20, 221, 541))
        self.toolBox.setObjectName("toolBox")
        self.page = QtWidgets.QWidget()
        self.page.setGeometry(QtCore.QRect(0, 0, 221, 425))
        self.page.setObjectName("page")
        self.toolButton = QtWidgets.QToolButton(parent=self.page)
        self.toolButton.setGeometry(QtCore.QRect(0, 0, 221, 41))
        icon = QtGui.QIcon()
        ...
        self.toolButton_2.setGeometry(QtCore.QRect(0, 40, 221, 41))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../Python课程/PyQt6 Python桌面开发 视频教程 2024版/配套源码/PyQt6Project2/PyQt6常用基本控件/容器控件/2.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.toolButton_3.setGeometry(QtCore.QRect(0, 80, 221, 41))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../Python课程/PyQt6 Python桌面开发 视频教程 2024版/配套源码/PyQt6Project2/PyQt6常用基本控件/容器控件/4.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 221, 425))
        self.page_2.setObjectName("page_2")
        self.toolButton_4 = QtWidgets.QToolButton(parent=self.page_2)
        self.toolButton_4.setGeometry(QtCore.QRect(0, 0, 221, 41))
        ...
        self.toolButton_5.setGeometry(QtCore.QRect(0, 0, 221, 41))
        ...
        self.toolButton_6.setGeometry(QtCore.QRect(0, 0, 221, 41))
    ...
    def retranslateUi(self, Form):
        ...
        self.toolButton_5.setText(_translate("Form", "傻逼"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("Form", "家人"))
        self.toolButton_6.setText(_translate("Form", "垃圾"))
